                    ...
                    try
                    {
                        ...
                        row["package"] = new Dictionary<string, object?>
                        {
                            ...
                            ["stmg"] = new Dictionary<string, object?>
                            {
                                ...
                                ["tailTrailingBytesNotZero"] = (long)package.Stmg.TailTrailingBytesNotZero,
                                ["tailRunNotFound"] = (long)package.Stmg.TailRunNotFound,
                                ["tailRunsCheckable"] = (long)package.Stmg.TailRunsCheckable,
                                ["tailCountDoesNotMatchTheRun"] = (long)package.Stmg.TailCountDoesNotMatchTheRun,
                                ["tailRunsFramed"] = (long)package.Stmg.TailRunsFramed,
                                ["tailRecords"] = (long)package.Stmg.TailRecords,
                                ["tailDistinctIds"] = (long)package.Stmg.TailDistinctIds,
                                ["tailFloatsTested"] = (long)package.Stmg.TailFloatsTested,
                                ["tailFloatsBounded"] = (long)package.Stmg.TailFloatsBounded,
                                ["tailRivalStridesTested"] = (long)package.Stmg.TailRivalStridesTested,
                                ["tailRivalStridesWithDistinctIds"] = (long)package.Stmg.TailRivalStridesWithDistinctIds,
                                ["tailRivalStridesWithTheZeroRun"] = (long)package.Stmg.TailRivalStridesWithTheZeroRun,
                                ["entryBlocks"] = (long)package.Stmg.EntryBlocks,
                                ["entryBlockBytes"] = (long)package.Stmg.EntryBlockBytes,
                                ["entryBlocksTooShort"] = (long)package.Stmg.EntryBlocksTooShort,
                                ["entryCountOutOfRange"] = (long)package.Stmg.EntryCountOutOfRange,
                                ["entryHeadPastTheEnd"] = (long)package.Stmg.EntryHeadPastTheEnd,
                                ["entryRecordCountOutOfRange"] = (long)package.Stmg.EntryRecordCountOutOfRange,
                                ["entryRecordsPastTheEnd"] = (long)package.Stmg.EntryRecordsPastTheEnd,
                                ["entryBlocksNotClosing"] = (long)package.Stmg.EntryBlocksNotClosing,
                                ["entryBlocksFramed"] = (long)package.Stmg.EntryBlocksFramed,
                                ["entries"] = (long)package.Stmg.Entries,
                                ["distinctEntryIds"] = (long)package.Stmg.DistinctEntryIds,
                                ["entryRecords"] = (long)package.Stmg.EntryRecords,
                                ["entryRecordsCarryingTheMarker"] = (long)package.Stmg.EntryRecordsCarryingTheMarker,
                                ["entryRecordCounts"] = package.Stmg.EntryRecordCounts.OrderBy(z => z.Key, StringComparer.Ordinal).ToDictionary(z => z.Key, z => z.Value),
                                ["tailSelectors"] = package.Stmg.TailSelectors.OrderBy(z => z.Key, StringComparer.Ordinal).ToDictionary(z => z.Key, z => z.Value),
                            ...
                            ["hircMusicReach"] = new Dictionary<string, object?>
                            {
                                ["musicObjects"] = (long)package.MusicReach.MusicObjects,
                                ["entryEdges"] = (long)package.MusicReach.EntryEdges,
                                ["banksWithAnEntry"] = (long)package.MusicReach.BanksWithAnEntry,
                                ["reachedObjects"] = (long)package.MusicReach.ReachedObjects,
                                ["reachedSourceIdCount"] = (long)package.MusicReach.ReachedSourceIdCount,
                                ["edges"] = (long)package.MusicReach.Edges,
                                ["edgeSources"] = (long)package.MusicReach.EdgeSources,
                                ["rootsWithNoIncomingEdge"] = (long)package.MusicReach.RootsWithNoIncomingEdge,
                                ["entriesWithOutgoingEdges"] = (long)package.MusicReach.EntriesWithOutgoingEdges,
                                ["entriesThatAreRoots"] = (long)package.MusicReach.EntriesThatAreRoots,
                                ["rootTypes"] = package.MusicReach.RootTypes.OrderBy(z => z.Key, StringComparer.Ordinal).ToDictionary(z => z.Key, z => z.Value),
                                ["entryKinds"] = package.MusicReach.EntryKinds.OrderBy(z => z.Key, StringComparer.Ordinal).ToDictionary(z => z.Key, z => z.Value),
                                ["reachedTypes"] = package.MusicReach.ReachedTypes.OrderBy(z => z.Key, StringComparer.Ordinal).ToDictionary(z => z.Key, z => z.Value),
                            },
